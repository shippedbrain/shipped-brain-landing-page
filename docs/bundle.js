...
/* harmony import */ var _dist_js_prettify__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(332);
/* harmony import */ var _dist_js_prettify__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_dist_js_prettify__WEBPACK_IMPORTED_MODULE_0__);

var navMenuToggle = document.getElementById('navMenuToggle');
var navMenuCloseBtn = document.getElementById('navOverlayCloseBtn');
var navFullscreen = document.getElementById('navbarFullScreen');
var navIntegrationLink = document.getElementById('navIntegrationLink');
/**
 * Method to handle tab switching
 */

function toggleTab() {
  var tabToggles = Array.from(document.getElementsByClassName('tab-toggle'));
  tabToggles.forEach(function (toggle) {
    toggle.addEventListener('click', function () {
      var dataTarget = toggle.getAttribute('data-target');
      var tabHeader = document.getElementById(toggle.getAttribute('data-tab-header'));
      var tabContentGroup = document.getElementById(toggle.getAttribute('data-content-group'));
      var type = toggle.getAttribute('data-type');
      var targetContent = document.getElementById(dataTarget);
      Array.from(tabHeader.children).forEach(function (tabPill) {
        removeActiveFromElement(tabPill.id);
      });
      Array.from(tabContentGroup.children).forEach(function (tabContent) {
      ...
      _dist_js_prettify__WEBPACK_IMPORTED_MODULE_0___default().prettyPrint();
    });
  });
}
...
function setCodeExample() {
  var toggle = document.getElementById('pythonTabToggle');
  var dataTarget = 'pythonExample';
  var targetContent = document.getElementById(dataTarget);
  toggle.classList.add('active');
  targetContent.classList.add('active');
  targetContent.innerHTML = getCodeExample(dataTarget);
...
function setCurrentYearOnFooter() {
  var footerYearElement = document.getElementById('footerYear');
...
navIntegrationLink.addEventListener('click', function () {
  toggleFullscreenNav(false);
});
